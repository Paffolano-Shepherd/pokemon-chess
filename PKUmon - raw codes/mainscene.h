...
public:
    ...
    void buildpath(qreal px, qreal py);
        ...
        /*void buildbuilding3(Mainscene* scene_at3,Mainscene* scene_bd3,qreal ux3,qreal uy3,int bdnum3);
        void buildbuilding4(Mainscene* scene_at4,Mainscene* scene_bd4,qreal ux4,qreal uy4,int bdnum4);*/
