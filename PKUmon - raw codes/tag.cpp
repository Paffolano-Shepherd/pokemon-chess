...
void Tag::setAllPos()
{
    ...
    tag_Name.setPos(x()+70,y()+10);tag_Level.setPos(x()+250,y()+10);
    ...
    tag_MPbar->setPos(xmreal,tag_MP.pos().y()+tag_MP.boundingRect().height()-15);
    tag_Expbar->setPos(xmreal,tag_Exp.pos().y()+tag_Exp.boundingRect().height()-17);
    tag_Skill1.setPos(x()+70,y()+75);
    tag_Skill2.setPos(x()+70,y()+93);
    tag_description.setPos(x()+10,y()+110);
}
