...
Scene8::Scene8(int sx, int sy, QGraphicsScene *parent)
{
    ...
    QString AString[4]={":/images/images/A2.png",":/images/images/A3.png",":/images/images/A4.png",":/images/images/A5.png"};
        ...
        {{"我：你好，请问你是学神吗？",-1},
         ...
         {"我：啊？为什么？",-1},
         {"C:想当年，我打羽毛球时能用手感知风速，然后用空气动力学计算球的轨迹。",0},
         {"C:打出完美一击，自以为天下无敌，于是来挑战学神。",0},
         {"C:最后...唉。所以我现在正在潜心修炼自己。你还是不要自不量力了，快走吧。",0},
         {"我：哦是这样啊，那你加油哦（憋装B了吧😒ヽ(･ω･´ﾒ)）",-1}};
        buildCharacter(5,CString,450,500,7,CWords,":/images/images/C_head.png",NULL,NULL);

        QString DString[4]={":/images/images/D2.png",":/images/images/D3.png",":/images/images/D4.png",":/images/images/D5.png"};
        TextInf DWords[5]=
        {{"这句话只是用来debug的...",-1},
         {"D:你就是那个一直在找我的年轻人啊？",0},
         {"我:是啊巨神！从小我就听说你GPA3.98的传奇了，钦慕已久，今日特来拜会！",-1},
         {"D:呵呵，我的GPA早就已经到4.0了。现在我是超神！",0},
         {"D:既然你这么诚心诚意地来找我，那我就大发慈悲地让你开开眼界吧！",0}};
        buildCharacter(2,DString,450,700,5,DWords,":/images/images/D_head.png",NULL,new characterData(_D_));
